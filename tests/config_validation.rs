...
use loongclaw::config::{Config, WorkingDirIsolation};
...
fn minimal_config() -> Config {
    Config {
        ...
        web_fetch_validation:
            loongclaw_tools::web_content_validation::WebContentValidationConfig::default(),
        web_fetch_url_validation: loongclaw_tools::web_fetch::WebFetchUrlValidationConfig::default(
        ),
        model_prices: vec![],
        ...
        soul_path: None,
        clawhub: loongclaw::config::ClawHubConfig::default(),
        plugins: loongclaw::plugins::PluginsConfig::default(),
...
data_dir: /data/loongclaw
working_dir: /data/loongclaw/tmp
...
"#;
    ...
    assert_eq!(config.data_dir, "/data/loongclaw");
    assert_eq!(config.working_dir, "/data/loongclaw/tmp");
...
fn test_data_dir_paths() {
    ...
    config.data_dir = "/opt/loongclaw.data".into();
