...
class Microclaw < Formula
  ...
  def install
    bin.install "loongclaw"
  end

  test do
    assert_match "LoongClaw", shell_output("#{bin}/loongclaw help")
  end
end
RUBY

git add .
git commit -m "loongclaw homebrew release $NEW_VERSION"
...
echo "  brew tap loongclaw/tap"
echo "  brew install loongclaw"
