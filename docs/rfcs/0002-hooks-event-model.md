...
LoongClaw has risk-gating in tool runtime but lacks a general lifecycle hook system for policy injection, auditing, and extension.
...
- `loongclaw hooks list`
- `loongclaw hooks info <name>`
- `loongclaw hooks enable <name>`
- `loongclaw hooks disable <name>`
