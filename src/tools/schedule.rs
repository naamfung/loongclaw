...
use loongclaw_channels::channel::enforce_channel_policy;
use loongclaw_channels::channel_adapter::ChannelRegistry;
use loongclaw_core::llm_types::ToolDefinition;
use loongclaw_storage::db::{call_blocking, Database};
...
mod tests {
    ...
    fn test_db() -> (Arc<Database>, std::path::PathBuf) {
        let dir = std::env::temp_dir().join(format!("loongclaw_sched_{}", uuid::Uuid::new_v4()));
