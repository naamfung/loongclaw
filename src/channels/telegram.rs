...
use loongclaw_channels::channel_adapter::ChannelAdapter;
#[cfg(test)]
use loongclaw_core::llm_types::{ContentBlock, ImageSource, MessageContent};
use loongclaw_core::text::floor_char_boundary;
use loongclaw_storage::db::{call_blocking, StoredMessage};
...
pub async fn transcribe_audio(
    ...
    if provider == "local" {
        ...
        loongclaw_app::transcribe::transcribe_audio(openai_key, audio_bytes).await
    }
}
...
mod tests {
    ...
    use loongclaw_storage::db::StoredMessage;
    ...
    fn test_render_markdown_v2_safe_heading_and_bold() {
        ...
        assert!(rendered.contains("I am *LoongClawBot*"));
    }
